...
const HVAC = () => {
    ...
    return (
        <div className="container mx-auto py-4 pt-10 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden" id="HVAC">
            <div className="relative w-full mb-4">
                ...
                <h1 className="w-full text-2xl sm:text-4xl font-bold text-center whitespace-nowrap overflow-hidden text-ellipsis px-4">
                    Our <span className="font-light underline underline-offset-4 decoration-1">HVAC</span> Products
                </h1>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center px-4">
                ...
                <p className="mt-4 text-gray-700 max-w-lg">
                    NexA is a company specializing in high-quality HVAC and elevator solutions,
