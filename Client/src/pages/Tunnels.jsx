...
const Tunnels = () => {
    ...
    return (
        <div className="container mx-auto py-4 pt-10 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden" id="Tunnels">
            <div className="relative w-full mb-4">
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2">
                    {!isMobile ? (
                        <div className="flex items-center text-lg">
                            ...
                            <span className="text-gray-600">Tunnels</span>
                        </div>
                    ) : (
                        <ArrowLeft
                            size={24}
                ...
                <h1 className="w-full text-2xl sm:text-4xl font-bold text-center whitespace-nowrap overflow-hidden text-ellipsis px-4">
                    Our <span className="font-light underline underline-offset-4 decoration-1">Tunnel</span> Projects
                </h1>
            </div>
            ...
            <div className="flex flex-col items-center justify-center text-center px-4">
                ...
                <p className="mt-4 text-gray-700 max-w-lg">
                    NexA is a pioneer in tunnel construction and infrastructure development,
                    focusing on durability, safety, and cutting-edge technology.
                    New projects will be revealed soon!
                </p>
            </div>
        </div>
    );
